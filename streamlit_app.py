...
if app_page == 'Introduction':
    ...
    st.subheader("03 Distribution analysis")
    fig, ax = plt.subplots(figsize=(10, 6))
    sns.histplot(df['variable'], bins=bin_size, kde=False, color='skyblue', ax=ax, label='Histogram')
    sns.kdeplot(df['variable'], color='red', ax=ax, label='Density Plot')
    ax.set_title('Histogram and Density Plot', fontsize=16)
